...
__all__ = ['visualize_ranked_results', 'tsne']
...
def tsne(features, label):
    ...
    x_tsne = t_sne.fit_transform(features)
    print(
        f'ori data dimension is {features.shape[-1]}.Embedded data dimension is {x_tsne.shape[-1]}'
    )
