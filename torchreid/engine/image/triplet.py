...
from torchreid.losses import TripletLoss, CrossEntropyLoss, CenterLoss, TheoreTripletLoss, SoftMarginTripletLoss, RangeLoss
...
class ImageTripletEngine(Engine):
    def __init__(self,
        ...
        elif type_name == 'softmargintriplet':
            print("using softmargintriplet...")
            tripletLoss = SoftMarginTripletLoss
        elif type_name == 'theoretriplet':
            print("using theoretriplet...")
            tripletLoss = TheoreTripletLoss
